...
namespace Crowds
{
	...
	class Prey : public Boid
	{
		...
		std::shared_ptr<AI::Tasks::Task> defaultTask = AI::Tasks::makeTask([this]()
			{
		...
		std::shared_ptr<AI::Tasks::Task> thirstyTask = AI::Tasks::makeTask([this]()
			{
	...
	public:
		...
		{
			thirstiness = Math::Interval<float>(0, 10.0).random();
			inWater = false;
			lastSecond = clock();
